...
export const Badge = ({ technology, size }: BadgeProps) => {
    ...
    const animationVariants = [
        { initial: { x: 50, scale: 0.2, opacity: 0 }, whileInView: { x: 0, scale: 1, opacity: 1 }, className: "z-10" },
        { initial: { scale: 0.2, opacity: 0 }, whileInView: { scale: 1, opacity: 1 }, className: "z-20" },
        { initial: { x: -50, scale: 0.2, opacity: 0 }, whileInView: { x: 0, scale: 1, opacity: 1 }, className: "z-9" }
    ];
